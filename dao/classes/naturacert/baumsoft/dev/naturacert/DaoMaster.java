...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        g1p1Dao.createTable(db, ifNotExists);
        g1p2Dao.createTable(db, ifNotExists);
        g1p3Dao.createTable(db, ifNotExists);
        g1p4Dao.createTable(db, ifNotExists);
        g2p1Dao.createTable(db, ifNotExists);
        g2p2Dao.createTable(db, ifNotExists);
        g2p3Dao.createTable(db, ifNotExists);
        g3p1Dao.createTable(db, ifNotExists);
        g3p2Dao.createTable(db, ifNotExists);
        g3p3Dao.createTable(db, ifNotExists);
        g3p4Dao.createTable(db, ifNotExists);
        g3p5Dao.createTable(db, ifNotExists);
        g3p6Dao.createTable(db, ifNotExists);
        g3p7Dao.createTable(db, ifNotExists);
        g3p8Dao.createTable(db, ifNotExists);
        g3p9Dao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        g1p1Dao.dropTable(db, ifExists);
        g1p2Dao.dropTable(db, ifExists);
        g1p3Dao.dropTable(db, ifExists);
        g1p4Dao.dropTable(db, ifExists);
        g2p1Dao.dropTable(db, ifExists);
        g2p2Dao.dropTable(db, ifExists);
        g2p3Dao.dropTable(db, ifExists);
        g3p1Dao.dropTable(db, ifExists);
        g3p2Dao.dropTable(db, ifExists);
        g3p3Dao.dropTable(db, ifExists);
        g3p4Dao.dropTable(db, ifExists);
        g3p5Dao.dropTable(db, ifExists);
        g3p6Dao.dropTable(db, ifExists);
        g3p7Dao.dropTable(db, ifExists);
        g3p8Dao.dropTable(db, ifExists);
        g3p9Dao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(g1p1Dao.class);
        registerDaoClass(g1p2Dao.class);
        registerDaoClass(g1p3Dao.class);
        registerDaoClass(g1p4Dao.class);
        registerDaoClass(g2p1Dao.class);
        registerDaoClass(g2p2Dao.class);
        registerDaoClass(g2p3Dao.class);
        registerDaoClass(g3p1Dao.class);
        registerDaoClass(g3p2Dao.class);
        registerDaoClass(g3p3Dao.class);
        registerDaoClass(g3p4Dao.class);
        registerDaoClass(g3p5Dao.class);
        registerDaoClass(g3p6Dao.class);
        registerDaoClass(g3p7Dao.class);
        registerDaoClass(g3p8Dao.class);
        registerDaoClass(g3p9Dao.class);
